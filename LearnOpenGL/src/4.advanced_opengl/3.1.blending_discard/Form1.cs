...
namespace _3._1.blending_discard
{
    public partial class Form1 : Form
    {
        ...
        /// 草的位置信息
        /// </summary>
        List<vec3> vegetation = new List<vec3>
        {
        ...
        public Form1()
        {
            ...
            transparentTexture.Create(GL, "grass.png",false);
        }
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            //创建着色器
            shader.Create(GL, "3.1.blending.vs", "3.1.blending.fs");
