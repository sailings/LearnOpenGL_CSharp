...
namespace _4._2.lighting_maps_specular_map
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            //创建两个Shader
            cubeShaderProgram.Create(GL, "4.2.lighting_maps.vs", "4.2.lighting_maps.fs");
            lampShaderProgram.Create(GL, "4.2.lamp.vs", "4.2.lamp.fs");
