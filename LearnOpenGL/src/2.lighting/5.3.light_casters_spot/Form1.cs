...
namespace _5._3.light_casters_spot
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            //创建两个Shader
            cubeShaderProgram.Create(GL, "5.3.light_casters.vs", "5.3.light_casters.fs");
            lampShaderProgram.Create(GL, "5.3.lamp.vs", "5.3.lamp.fs");
