...
namespace _2._2.basic_lighting_specular
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLDraw(object sender, SharpGL.RenderEventArgs args)
        {
            ...
            cubeShaderProgram.SetUniform3(GL, "lightPos", lightPos.x, lightPos.y, lightPos.z);
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            //创建两个Shader
            cubeShaderProgram.Create(GL, "2.2.basic_lighting.vs", "2.2.basic_lighting.fs");
            lampShaderProgram.Create(GL, "2.2.lamp.vs", "2.2.lamp.fs");
