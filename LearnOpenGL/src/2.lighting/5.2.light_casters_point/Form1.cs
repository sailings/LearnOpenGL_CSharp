...
namespace _5._2.light_casters_point
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            //创建两个Shader
            cubeShaderProgram.Create(GL, "5.2.light_casters.vs", "5.2.light_casters.fs");
            lampShaderProgram.Create(GL, "5.2.lamp.vs", "5.2.lamp.fs");
