...
namespace _6._1.coordinate_systems
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            using (StreamReader sr = new StreamReader("6.1.coordinate_systems.vs"))
            {
                vertexShaderSource = sr.ReadToEnd();
            }

            using (StreamReader sr = new StreamReader("6.1.coordinate_systems.fs"))
            {
