...
namespace _7._1.camera_circle
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLDraw(object sender, SharpGL.RenderEventArgs args)
        {
            ...
            float radius = 10.0f;
            var camX = (float)Math.Sin((double)(DateTime.Now-startTime).TotalSeconds) * radius;
            var camZ = (float)Math.Cos((double)(DateTime.Now - startTime).TotalSeconds) * radius;
            view = glm.lookAt(new vec3(camX, 0.0f, camZ), new vec3(0.0f, 0.0f, 0.0f), new vec3(0.0f, 1.0f, 0.0f));
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            using (StreamReader sr = new StreamReader("7.1.camera.vs"))
            {
                vertexShaderSource = sr.ReadToEnd();
            }

            using (StreamReader sr = new StreamReader("7.1.camera.fs"))
            {
