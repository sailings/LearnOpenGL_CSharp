...
namespace _3._1.shaders_uniform
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLDraw(object sender, SharpGL.RenderEventArgs args)
        {
            ...
            //根据当前时间获取绿色值
            var greenValue = Math.Sin((DateTime.Now - startTime).TotalSeconds) / 2.0f + 0.5f;

            //传递给shader中的ourColor
            shaderProgram.SetUniform4(GL, "ourColor", 0.0f, (float)greenValue, 0.0f, 1.0f);
