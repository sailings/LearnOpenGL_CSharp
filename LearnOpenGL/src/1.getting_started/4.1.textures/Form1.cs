...
namespace _4._1.textures
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //创建纹理
            texture.Create(GL, "container.jpg");
        }
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            using (StreamReader sr = new StreamReader("4.1.texture.vs"))
            {
                vertexShaderSource = sr.ReadToEnd();
            }

            using (StreamReader sr = new StreamReader("4.1.texture.fs"))
            {
