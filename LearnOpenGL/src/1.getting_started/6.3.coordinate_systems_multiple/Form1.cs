...
namespace _6._3.coordinate_systems_multiple
{
    public partial class Form1 : Form
    {
        ...
        private void OpenGLControl1_OpenGLDraw(object sender, SharpGL.RenderEventArgs args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                float angle = 20.0f * i;
                if (i % 3 == 0)
                    angle = (float)(DateTime.Now - startTime).TotalSeconds * 25.0f;
                //旋转
        ...
        private void OpenGLControl1_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            using (StreamReader sr = new StreamReader("6.3.coordinate_systems.vs"))
            {
                vertexShaderSource = sr.ReadToEnd();
            }

            using (StreamReader sr = new StreamReader("6.3.coordinate_systems.fs"))
            {
